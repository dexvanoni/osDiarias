...
<body>
  ...
  <div class="cabecalho">
      <center><font style="font: Arial">COMANDO DA AERONÁUTICA</font></center>
      <center>GRUPAMENTO DE APOIO DE CAMPO GRANDE</center>
      <center>ORDEM DE SERVIÇO DE SOLICITAÇÃO DE DIÁRIAS Nº {{ $os->id }}</center>
      <center><sup>1</sup>SC:{{ $os->sc }}</center>
  </div>
  <div class="pcdp">
    <center>
